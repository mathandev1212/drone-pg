...
url = urlparse("postgresql://drone_z2zm_user:9N7Rbvdo0sS2vLsljOge2k5efbtPhHHY@dpg-cqfmi62ju9rs73bvskng-a.oregon-postgres.render.com/drone_z2zm")

# Extract connection parameters
db_params = {
    'host': "dpg-cqfmi62ju9rs73bvskng-a.render.com",
    'user': url.username,
